...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url() ?>misc/js/jquery-1.8.1.min.js"></script>
...
<body link="blue" alink="blue" vlink="blue">
  ...
  <!--<h1 id="oj_title" align="center"><?php echo $this->config->item('site_title') ?></h1>-->
